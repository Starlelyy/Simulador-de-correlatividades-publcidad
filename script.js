const materias = [
...

  {
    ...
    requiere: ["Historia social general", "introducción a la comunicación"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    nombre: "psicología social",
    requiere: ["Introducción a la Sociología", "psicología general"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    nombre: "lingüística",
    requiere: ["Introducción a la Sociología", "taller de lectura y escritura"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    nombre: "comunicación visual",
    requiere: ["introducción a la comunicación", "taller de lectura y escritura"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    nombre: "marketing I",
    requiere: ["economía general", "introducción a la comunicación"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    nombre: "diseño y producción gráfica",
    requiere: ["comunicación visual", "introducción a la publicidad"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "metodología de la investigación social",
    requiere: ["Filosofía", "Introducción a la Sociología"],
    tipo: ["aprobada", "aprobada"]
  },
...

  {
    ...
    requiere: ["marketing I", "introducción a la publicidad"],
    tipo: ["regularizada", "aprobada"]
  },
...

  {
    ...
    requiere: ["diseño y producción gráfica", "comunicación visual"],
    tipo: ["regularizada", "aprobada"]
  },
...

  {
    ...
    requiere: ["medios de comunicación publicitaria", "comunicación I"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "opinión pública",
    requiere: ["metodología de la investigación social"],
    tipo: ["aprobada"]
  },
...

  {
    ...
    requiere: ["comunicación II", "comunicación I"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "Semiología",
    requiere: ["redacción publicitaria", "lingüística"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "organización y administración de la empresa publicitaria",
    requiere: ["planificación de medios", "medios de comunicación publicitaria"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "diseño multimedial",
    requiere: ["Producción audiovisual", "diseño y producción gráfica"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "investigación en publicidad",
    requiere: ["opinión pública", "metodología de la investigación social"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "prensa y comunicación institucional",
    requiere: ["comunicación II", "psicología social"],
    tipo: ["regularizada", "aprobada"]
  },

  {
    nombre: "política de los medios de comunicación social",
    requiere: ["comunicación I", "medios de comunicación publicitaria"],
    tipo: ["aprobada", "aprobada"]
  },

  {
    ...
    tipo: ["regularizada", "regularizada", "aprobada"]
  },

  {
    nombre: "creatividad en publicidad",
    requiere: ["diseño multimedial", "Producción audiovisual"],
    tipo: ["regularizada", "aprobada"]
  }
];
...
function cargarEstado() {
  ...
  const estado = JSON.parse(
    localStorage.getItem("estadoMaterias") || "{}"
  );
